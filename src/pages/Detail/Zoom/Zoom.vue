<template>
  <div class="spec-preview">
    <!--  Cannot read property '0' of undefined"会报这个错，但是页面展示没问题（假报错）-->
...
<script>
  export default {
    ...
    methods: {
      ...
      move(event) {
        //鼠标动，蒙版动  想办法去让蒙版跟随鼠标移动
        // 转化为根据鼠标的位置求蒙版的位置
        // event.clientX    相对浏览器可视区左上角，视口是不变的
        // event.pageX      相对页面左上角
        // event.offsetX    相对事件源左上角
